...
#    - method_override: DeepseekV4SparseMoeBlock.forward
#      Report DeepseekV4 top-k indices to the MoE load-balance monitor
#    - method_override: DeepseekV4ForCausalLM.forward
#      OpSlot guards for fused CE and load-balancing loss in DeepseekV4ForCausalLM.forward
